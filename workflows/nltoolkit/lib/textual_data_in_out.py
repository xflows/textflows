...
def load_adc(input_dict):
    ...
    documents,labels = process_adc(input_text, input_dict['tab_separated_title'] == "true", input_dict['leading_labels'] == "true")
    features = {u"Source": "string", u"SourceDate": source_date, u"CorpusCreateDate": corpus_date, "Labels":labels}
